...
function ekraniCiz() {
    ...
    todayProg.forEach(s => {
        ...
        s.meds.forEach(m => {
            ...
            if(m.key === 'GECE_FOLBIOL' && dNow.getDay() === 5 && !alertsHTML.includes('Folbiol')) alertsHTML += `<div class="safety-shield shield-yellow" style="display:block;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 8px; position: relative; top: -1px;"><path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"/><path d="m8.5 8.5 7 7"/></svg>Bugün Folbiol Günü</div>`;
            if(m.key === 'GECE_METOARTCON') alertsHTML += `<div class="safety-shield shield-blue" style="display:block;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 8px; position: relative; top: -1px;"><path d="m19 5-3.5 3.5M14 3l3.5 3.5M17 10l2.5 2.5M11.5 6.5l6 6-8.5 8.5-6-6zM7 16l-4 4M2 22l3-3"/></svg>Bugün Metoartcon İğne Günü</div>`;
            if(m.key === 'GECE_CIMZIA') alertsHTML += `<div class="safety-shield shield-purple" style="display:block;"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 8px; position: relative; top: -1px;"><path d="m19 5-3.5 3.5M14 3l3.5 3.5M17 10l2.5 2.5M11.5 6.5l6 6-8.5 8.5-6-6zM7 16l-4 4M2 22l3-3"/></svg>Bugün Cimzia İğne Günü!</div>`;
        });
    });
